...
$chars = @(
    ...
    @{ Hash = '2A26B1B2'; Awake = '52A6E299'; T1 = 'CD030268'; T2 = 'A38510E2'; War = 'DADE14DC' }, # Gran
    ...
    @{ Hash = 'A3A3CB2F'; Awake = 'AF8E7E7E'; T1 = '93A2093C'; T2 = '7AD0C010'; War = 'B064A634' }, # Id
...
foreach ($c in $chars) {
    ...
    $resolved += [pscustomobject]@{
        Hash = $c.Hash; T1 = $c.T1; T2 = $c.T2; War = $c.War
