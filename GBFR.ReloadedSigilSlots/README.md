...
为全角色扩展 6 个因子槽位并固定配装，不占用本体 12 槽位。无需库存、不写存档。

[Mod 仓库](https://github.com/baagod/GBFR-Pre-Equipped-Sigils)

**这个 Mod 的本质是，把这几个 “必带槽” 从玩家的预算里抽走，本体 12 槽留给玩家自由发挥，每个角色都能多出几成配装自由。**
...
1. 安装 [Reloaded-II](https://github.com/Reloaded-II/Reloaded-II) ( 1.30.3+ )；
