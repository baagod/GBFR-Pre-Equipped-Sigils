...
const HEADER_ROW = `${GRID_COLS} min-h-[48px] border-b text-sm font-medium text-foreground`
  ...
  return (
    <div>
      {table.map((e) => {
        ...
        const row = [
          { key: "t1" as const, on: t1, gem: e.t1Gem },
          { key: "t2" as const, on: t2, gem: e.t2Gem },
          { key: "war" as const, on: war, gem: e.warGem },
        ]
        const characterName =
