...
//   slot 6: 守护Ⅴ＋           (守护 + 躲避性能)
//   slot 7: 追击Ⅴ＋           (追击 + 迅捷能力)
//   slot 8: 可怕的漆黑钳蟹因子 Lv20 (event sigil, single trait)
//
...
constexpr CharacterTemplate kDefaultTemplates[] = {
   { 0x079DF0CC, { // character
      ...
      TemplateGemSlot{0x1E2EBC39, 0x57AB5B10, 15, 0x318D12E9, 15, 15}, // slot7 Pursuit V+ + Swift Ability V+
      TemplateGemSlot{0x49434696, 0xBF78FBFC, 20, 0x887AE0B0, 0, 20}, // slot8 可怕的漆黑钳蟹因子 Lv20 (event sigil)
   }},
